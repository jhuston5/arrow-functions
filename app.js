...
// Cannot use arrow functions to as constructors or methods per MDN
...
// this in joe.scope() is the referring to the local function. Since this is a prototype method, it is used to access the constructor function it is used in.
// 2. What is "this" when joe.scopeArrow() is invoked?
// This is returning a bunch of data that can be found in the console, about the window - potentially it's location, etc.
// 3. Explain why "this" is different when an arrow function is used.
// Essentially since the arrow function assumes that this is the window or global scope (per MDN), we can't create local scope. 